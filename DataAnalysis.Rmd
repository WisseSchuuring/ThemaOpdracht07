...
boxplot(log2(ref_out + 1), data=MyData, main="Gene expression between Parental and IRF2 KO",
   xlab="Gene Samples", ylab="Log of Gene expressions", col = c("dark green","dark green","dark green","light green","light green","light green"))
