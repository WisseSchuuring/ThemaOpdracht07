...
counts_p <- select(MyData,c(1,2:4))
counts_KO <- select(MyData,c(1,6:8))
counts_total <- select(MyData,c(1,5,9))
compare_1_2 <- select(MyData,c(1,2,6))
compare_4_3 <- select(MyData,c(1,3,7))
compare_5_6 <-select(MyData,c(1,4,8))
