...
#if three have values of zero, remove them
row_sub <- apply(counts.fpm, 1, function(row) all(row > 1 ))
row_removed <- apply(counts.fpm, 1, function(row) any(row < 1))
...
cat("The total amount of genes in the data is",totalAmount,". Of those genes,",keepAmount,
    " were above a count of one, with",removeAmount," below. In conclusion,",keepPercent,
